        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full h-full overflow-y-auto px-4 custom-scrollbar">
            {tweets.map((tweet) => (
                <div
                    ...
                    className="bg-backgroundSecondary backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-700/30 cursor-pointer transform transition-all duration-200 hover:scale-[1.02] hover:border-[#BABABA] hover:shadow-xl"
                >
