...
const Roadmap = () => {
  return (
    <div id="roadmap" className="relative flex flex-col gap-6 mt-16">
      {/* Remove one of the two lines above: keep only the section title */}
      <h2 className="text-landing-title text-3xl lg:text-5xl px-6 md:px-12">Roadmap</h2>
      ...
      <div className="w-full border-b border-landing-border" />
    </div>
  )
}
